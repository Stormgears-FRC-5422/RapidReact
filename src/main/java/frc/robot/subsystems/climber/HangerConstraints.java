...
public class HangerConstraints {
  ...
  // kPivotLeadOffset = the number of rotations between home and the point where the pivot is
  // exactly vertical
  ...
  public static double getPivotPosition(double climberPosition) {
    ...
    double angleB =
        acos(
            (currentClimberLength * currentClimberLength
                    + kPivotLength * kPivotLength
                    - kBarDistance * kBarDistance)
    ...
    double D =
        q * q
            - 4.0
                * (kPivotMountLength * kPivotMountLength
                    - kPivotSupportLength * kPivotSupportLength);
