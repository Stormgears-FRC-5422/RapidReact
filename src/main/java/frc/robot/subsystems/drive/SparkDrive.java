...
public class SparkDrive extends StormDrive {
    ...
    private double conversionFactor[] = {0.0254 * kDriveWheelCircumference/kDriveGearBoxRatio,
                                         0.0254 * kRightSideSpeedScale*kDriveWheelCircumference/kDriveGearBoxRatio}; // set to provide measurement in meters per motor revolution
